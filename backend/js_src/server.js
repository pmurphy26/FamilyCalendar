...
app.use("/api", authMiddleware_1.requireAuth, eventsRoutes_1.default);
app.use("/api", authMiddleware_1.requireAuth, dayRoutes_1.default);
app.use("/api", authMiddleware_1.requireAuth, calendarRoutes_1.default);
app.use("/api", authMiddleware_1.requireAuth, transportationRoutes_1.default);
app.use("/api", authMiddleware_1.requireAuth, familyRoutes_1.default);
app.use("/api", authMiddleware_1.requireAuth, familyIndividualRoutes_1.default);
app.use("/api", authMiddleware_1.requireAuth, vehicleRoutes_1.default);
