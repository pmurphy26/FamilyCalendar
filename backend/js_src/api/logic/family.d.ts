...
export declare function getFamilyForIndividualWithID(id: number): Promise<Family | null>;
...
export declare function createNewFamily(): Promise<Family | null>;
export declare function getFamilyWithCode(code: string): Promise<number | null>;
