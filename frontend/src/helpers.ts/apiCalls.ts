 ...
 * @returns
 */
export async function editDrivingSituation(editedEvent: CalendarEvent) {
 ...
 * @returns
 */
export async function createDrivingSituation(editedEvent: CalendarEvent) {
...
export async function deleteFamilyMemberWithID(id: number): Promise<boolean> {
  const res = await fetch(
...
export async function updateVehicle(newVehicle: Vehicle): Promise<boolean> {
...
export async function deleteFamilyVehicleWithID(id: number): Promise<boolean> {
